<template>
  <div class="home px-4 sm:px-6 py-4">   
    ...
    <div class="blog-card-wrap">
      <div class="container">
        ...
        <h3 class="text-black dark:text-white flex items-center gap-2 font-bold tracking-tight fade-in-up">
          <span class="animated-gradient-text">최근 블로그 소식</span>
          <UIcon name="i-heroicons-sparkles" class="w-5 h-5 text-amber-500 animate-pulse" />
        </h3>
       
        <div class="blog-cards">
          <blog-card 
            :post="post" 
            v-for="(post, index) in cardStore.blogPosts" 
            :key="index" 
            class="fade-in-up"
        ...
        <div class="text-center">
          <UButton class="mt-10 hover:scale-105 transition-transform fade-in-up" @click="handleClick">더 보기</UButton>
        </div>
      </div>
    </div>                 
    <div ref="updatesRef" class="updates h-[300px] md:h-[250px] sm:h-[150px] fade-in-up">     
      <div class="container flex justify-between items-center">  
        <h2 class="jua-font leading-relaxed animated-gradient-text animate-float fade-in-up delay-100">
          다음세대를 위한 생물다양성 보존과 생태계 복원<br><br> 시민여러분과 함께 이루어 갑니다
        </h2>                
          <UButton v-if="!pEmail" trailing size="xl" to="/auth/login" icon="i-heroicons-arrow-long-right-solid" color="lime" class="router-button-1 mb-4 rounded-full text-slate-900 font-bold flex mr-10 jua-font hover:scale-110 transition-transform shadow-lg fade-in-up delay-200">
            회 원 가 입    
          </UButton>
          <UButton v-else trailing size="xl" to="/donation" icon="i-heroicons-arrow-long-right-solid" color="lime" class="router-button-1 mb-4 rounded-full text-slate-900 font-bold flex mr-10 jua-font hover:scale-110 transition-transform shadow-lg fade-in-up delay-200">
            후 원 하 기    
          </UButton>       
      </div>
    </div>
    ...
    <section ref="impactRef" id="impact" class="max-w-[1200px] mx-auto py-12 px-6 mb-16">
      <div class="text-center max-w-2xl mx-auto mb-12 space-y-3">
        <span class="inline-block text-[13px] font-bold text-green-600 uppercase tracking-widest bg-green-500/10 px-4 py-1.5 rounded-full animate-bounce-subtle fade-in-up">Ecological Impact</span>
        <h2 class="text-[30px] sm:text-[40px] font-bold dark:text-white !h-auto !mt-0 !line-height-normal animated-gradient-text fade-in-up delay-100">숫자로 보는 울산 독수리 생태계</h2>
        <p class="text-gray-700 dark:text-gray-300 text-[17px] fade-in-up delay-200"><strong>울산 독수리 학교는</strong> 야생동물을 보호하고, 시민 자원봉사와 생태교육을 통해 지속 가능한 생태 환경을 조성합니다.</p>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Stat Card 1 -->
        <div class="bg-white dark:bg-zinc-800 p-8 rounded-[32px] border border-black/10 dark:border-white/10 hover:-translate-y-2 transition-transform duration-300 shadow-md group fade-in-up delay-100">
          <div class="w-12 h-12 rounded-2xl bg-amber-500/10 text-amber-500 flex items-center justify-center mb-6 group-hover:bg-amber-500 group-hover:text-white transition-colors">
            <UIcon name="i-heroicons-paper-airplane" class="w-7 h-7 animate-pulse" />
          </div>
          <div class="text-[38px] font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 group-hover:text-amber-500 transition-colors">
            <span class="inline-block hover:scale-110 transition-transform">3,400</span><span class="text-[18px] font-bold text-gray-500 ml-1">km</span>
          </div>
        ...
        <!-- Stat Card 2 -->
        <div class="bg-white dark:bg-zinc-800 p-8 rounded-[32px] border border-black/10 dark:border-white/10 hover:-translate-y-2 transition-transform duration-300 shadow-md group fade-in-up delay-200">
          <div class="w-12 h-12 rounded-2xl bg-amber-500/10 text-amber-500 flex items-center justify-center mb-6 group-hover:bg-amber-500 group-hover:text-white transition-colors">
            <UIcon name="i-heroicons-sparkles" class="w-7 h-7 animate-spin-slow" />
          </div>
          <div class="text-[38px] font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 group-hover:text-amber-500 transition-colors">
            <span class="inline-block hover:scale-110 transition-transform">450</span><span class="text-[18px] font-bold text-gray-500 ml-1">마리+</span>
          </div>
        ...
        <!-- Stat Card 3 -->
        <div class="bg-white dark:bg-zinc-800 p-8 rounded-[32px] border border-black/10 dark:border-white/10 hover:-translate-y-2 transition-transform duration-300 shadow-md group fade-in-up delay-300">
          <div class="w-12 h-12 rounded-2xl bg-amber-500/10 text-amber-500 flex items-center justify-center mb-6 group-hover:bg-amber-500 group-hover:text-white transition-colors">
            <UIcon name="i-heroicons-heart" class="w-7 h-7 animate-pulse" />
          </div>
          <div class="text-[38px] font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 group-hover:text-amber-500 transition-colors">
            <span class="inline-block hover:scale-110 transition-transform">24</span><span class="text-[18px] font-bold text-gray-500 ml-1">톤+</span>
          </div>
        ...
        <!-- Stat Card 4 -->
        <div class="bg-white dark:bg-zinc-800 p-8 rounded-[32px] border border-black/10 dark:border-white/10 hover:-translate-y-2 transition-transform duration-300 shadow-md group fade-in-up delay-400">
          <div class="w-12 h-12 rounded-2xl bg-amber-500/10 text-amber-500 flex items-center justify-center mb-6 group-hover:bg-amber-500 group-hover:text-white transition-colors">
    ...
    <section ref="anatomyRef" id="anatomy" class="max-w-[1200px] mx-auto py-12 px-6 mb-20">
      <div class="bg-white dark:bg-zinc-800 rounded-[32px] border border-black/10 dark:border-white/10 p-8 sm:p-14 overflow-hidden relative shadow-lg">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div class="lg:col-span-6 space-y-6">
            <div class="inline-block bg-[#09090b] text-white dark:bg-amber-400 dark:text-slate-900 text-[12px] font-bold px-3.5 py-1 rounded-full uppercase tracking-wider animate-pulse fade-in-up">SPECIES SPECS</div>
            <h3 class="text-[30px] sm:text-[40px] font-bold text-gray-900 dark:text-white leading-tight !h-auto !mt-0 fade-in-up delay-100">
              자연의 청소부,<br/>
              <span class="animated-gradient-text">독수리(Cinereous Vulture)</span> 생태백과
            </h3>
            <p class="text-gray-600 dark:text-gray-300 text-[15px] leading-relaxed fade-in-up delay-200">
            ...
            <div class="space-y-3 pt-2 fade-in-up delay-300">
              <div 
              ...
              >
                <div class="flex justify-between items-center font-bold text-gray-900 dark:text-white text-[15px] group-hover:!text-white dark:group-hover:!text-slate-900 transition-colors duration-300">
                  <span class="flex items-center gap-2">
                    <UIcon :name="acc.icon" class="w-5 h-5 text-amber-500 animate-pulse" /> 
                    {{ acc.title }}
                  </span>
          ...
          <div class="lg:col-span-6 bg-slate-100 dark:bg-zinc-900 rounded-3xl p-8 border border-black/10 dark:border-white/10 relative text-center fade-in-up delay-200">
            <div class="text-[12px] font-bold text-amber-500 uppercase tracking-widest mb-4 animate-pulse">Size Comparison Visual</div>
            ...
            <div class="py-6 flex flex-col items-center justify-center space-y-6">
              <div class="w-full relative flex items-center justify-center">
                ...
                <svg class="w-full max-w-[380px] text-slate-800 dark:text-amber-400 h-auto drop-shadow-md animate-float" viewBox="0 0 300 120" fill="currentColor">
              ...
              <div class="w-full bg-slate-300 dark:bg-zinc-700 h-[2px] relative flex items-center justify-between">
                ...
                <span class="text-[11px] font-mono font-bold text-amber-500 bg-slate-100 dark:bg-zinc-900 px-2 animate-pulse">WingSpan 3.0m</span>
              ...
              <div class="grid grid-cols-2 gap-4 w-full pt-4">
                ...
                <div class="bg-white dark:bg-zinc-800 p-4 rounded-2xl border border-amber-500/50 shadow-sm hover:scale-105 transition-transform">
                  <span class="text-[12px] text-amber-600 font-semibold block">독수리 양 날개 폭</span>
                  <span class="text-[20px] font-bold text-amber-600 animated-gradient-text">~ 3.0 m</span>
                </div>
              </div>
            </div>
          </div>
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "name": "울산독수리.com",
        "url": "https://울산독수리.com",
        "description": "매년 11월 몽골에서 울산 태화강 삼호섬으로 날아오는 천연기념물 독수리 생태 기록 및 독수리학교 안내",
        "potentialAction": {
          "@type": "SearchAction",
          "target": "https://울산독수리.com/?search={search_term_string}",
...
useSeoMeta({
  title: '울산 독수리 학교 | Ulsan Vulture School - 태화강 삼호섬 독수리 월동 정보',
  ogTitle: '울산 독수리 학교 | Ulsan Vulture School',
  description: '몽골 고원에서 3,400km를 날아온 겨울 철새 독수리(Cinereous Vulture)들의 고귀한 생존 여정. 태화강 독수리학교와 실시간 생태 모니터링 정보를 전합니다.',
  ogDescription: '몽골 고원에서 3,400km를 날아온 겨울 철새 독수리(Cinereous Vulture)들의 고귀한 생존 여정.',
  ogImage: 'https://울산독수리.com/og_2.jpg',
...
onMounted(() => {
  if (process.client) {
    ...
    // .fade-in-up 클래스를 가진 모든 텍스트 및 카드 요소 자동 감지
    setTimeout(() => {
